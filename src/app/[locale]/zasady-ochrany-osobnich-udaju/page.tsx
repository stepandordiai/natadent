...
const PrivacyPolicy = () => {
	return (
		<>
			<Helmet>
				<title>Zásady zpracování osobních údajů (GDPR) | Natadent</title>
				<meta
					name="description"
					content="Zásady zpracování osobních údajů společnosti NATADENT s.r.o. v souladu s nařízením GDPR."
				/>
				<link rel="canonical" href="https://www.natadent.cz/gdpr" />
			</Helmet>
			<main>
				<PageTitle title="Zásady zpracování osobních údajů (GDPR)" />
				<Container>
						...
						<ol className="privacy-policy-list">
							...
							<li>
								...
								<ul>
									...
									<li>
										souhlasu subjektu údajů (např. u kontaktních formulářů)
									</li>
								</ul>
							</li>
							<li>
								...
								<ul>
									...
									<li>
										po dobu trvání komunikace a následně po přiměřenou dobu
									</li>
								</ul>
							</li>
							<li>
							...
							<li>
								Cookies
								<p>
									Naše webové stránky používají cookies za účelem zajištění
									jejich správného fungování a analýzy návštěvnosti. Používání
									cookies můžete upravit ve svém internetovém prohlížeči.
								</p>
							</li>
							<li>
